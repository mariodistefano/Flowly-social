...
{{-- <header class="container-fluid mb-4">
    <div class="row justify-content-between">
      ...
      <div class="col-md-6 mt-5">
          ...
          <h6 class="text-secondary ps-4 d-none d-md-block">i nostri articoli</h6>
      </div>

    @guest
    <div class="col-md-4 d-flex mt-2">
        <button class="btnHEADER d-none d-md-block ms-auto"><a class="text-white" href="{{route('login')}}"> Accedi</a></button>
