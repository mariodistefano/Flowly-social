<section class="light">
  ...
  {{-- flex-row-reverse ? --}}
      <article class="postcard2 postcard light yellow ">
        <a class="postcard2__img_link" href="#">
          <img class="postcard2__img" src="{{Storage::url($article->img)}}" alt="Image Title" />
        </a>
        <div class="postcard2__text t-dark">
